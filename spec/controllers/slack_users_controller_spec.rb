...
RSpec.describe SlackUsersController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: slack_user.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      slack_user = SlackUser.create! valid_attributes
      get :edit, params: {id: slack_user.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SlackUser" do
        expect {
          post :create, params: {slack_user: valid_attributes}, session: valid_session
        }.to change(SlackUser, :count).by(1)
      end

      it "redirects to the created slack_user" do
        post :create, params: {slack_user: valid_attributes}, session: valid_session
        expect(response).to redirect_to(SlackUser.last)
      end
    end

    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {slack_user: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
